...
import 'package:rab_rumahku/rab_engine.dart';

void main() {
  test('calculates geometry, materials, labor and total', () {
    final project = <String, dynamic>{
      'building': {
        'length': 6, 'width': 6, 'floors': 1, 'wallHeight': 3, 'roofPitch': 30, 'overhang': .5,
        'bathrooms': 1, 'terraceArea': 5, 'carportArea': 12,
        'openings': {'doors': 4, 'windows': 5, 'doorWidth': .9, 'doorHeight': 2.1, 'windowWidth': 1.2, 'windowHeight': 1.2},
      },
      'spec': {'wall': 'lightbrick', 'floor': 'tile', 'roofCover': 'genteng', 'ceiling': 'gypsum'},
      'waste': {'material': 5, 'tile': 7, 'brick': 5, 'paint': 5, 'roof': 5},
      'materialWaste': <String, dynamic>{}, 'coefficients': <String, dynamic>{}, 'laborPriceOverrides': <String, dynamic>{}, 'priceOverrides': <String, dynamic>{},
  ...
  test('project price overrides are respected', () {
    final project = <String, dynamic>{
      ...
      'spec': {'wall': 'lightbrick', 'floor': 'tile', 'roofCover': 'genteng', 'ceiling': 'gypsum'},
      'waste': {'material': 0, 'tile': 0, 'brick': 0, 'paint': 0, 'roof': 0}, 'priceOverrides': {'cement': 100000},
      'laborPriceOverrides': <String, dynamic>{}, 'coefficients': <String, dynamic>{}, 'materialWaste': <String, dynamic>{},
